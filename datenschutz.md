...
E-Mail: [andrea.boyer@muettergenesung-kur.de](mailto:andrea.boyer@muettergenesung-kur.de)

## 3. Anwendbares Datenschutzrecht

Für die Evangelische Müttergenesung Württemberg gGmbH gilt das  
**Datenschutzgesetz der Evangelischen Kirche in Deutschland (DSG-EKD)**  
[https://www.kirchenrecht-ekd.de/document/41335](https://www.kirchenrecht-ekd.de/document/41335)

Dieses Gesetz orientiert sich an der EU-Datenschutz-Grundverordnung (DSGVO):  
[https://de.wikipedia.org/wiki/Datenschutz-Grundverordnung](https://de.wikipedia.org/wiki/Datenschutz-Grundverordnung)

## 4. Ihre Rechte als betroffene Person

Wenn auf dieser Website personenbezogene Daten verarbeitet werden, haben Sie gemäß Kapitel 3 DSG-EKD folgende Rechte:
...
E-Mail: [info@datenschutz.ekd.de](mailto:info@datenschutz.ekd.de)  
Website: [https://datenschutz.ekd.de](https://datenschutz.ekd.de)

**Zuständige Außenstelle für Baden-Württemberg:**  
Außenstelle Ulm – Datenschutzregion Süd  
Hafenbad 22  
89073 Ulm

Telefon: 0731 / 140593-0  
E-Mail: [sued@datenschutz.ekd.de](mailto:sued@datenschutz.ekd.de)

## 6. Datenschutzbeauftragte

Verantwortlich für die Einhaltung des Datenschutzes ist die Leitung der Einrichtung. Zusätzlich wurde eine örtliche Datenschutzbeauftragte bestellt:

**Name:** Angela Finkenberger  
**E-Mail:** [datenschutz@muettergenesung-kur.de](mailto:datenschutz@muettergenesung-kur.de)  
**Telefon:** 0838 1913107

## 7. Server-Logdateien und IP-Adresse

Beim Besuch der Website wird Ihre IP-Adresse automatisch an den Server übermittelt, um die Inhalte korrekt anzuzeigen. Diese IP-Adresse gilt als personenbeziehbar.
...
## 8. Kein Profiling, keine Tracking-Technologien

Browser senden beim Besuch zusätzliche technische Daten (z. B. Auflösung, Sprache, Betriebssystem), die theoretisch zur Wiedererkennung genutzt werden könnten („Fingerprinting“).

**Unsere Zusage:**  
Wir betreiben kein Fingerprinting und keine personalisierte Nutzerverfolgung.
...
Wenn Sie sich per E-Mail in unsere Mailingliste eintragen lassen möchten:

- wird Ihre E-Mail-Adresse ausschließlich für den Versand von Informationen rund um unsere Arbeit verwendet.
- Es erfolgt kein automatisiertes Profiling, kein Tracking, keine Weitergabe an Dritte.
- Sie können sich jederzeit per E-Mail wieder austragen.
